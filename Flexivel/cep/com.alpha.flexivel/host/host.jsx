...
var CANDIDATOS_BASE = [
    "//192.168.1.15/uteis/_Padroes_clientes_Alpha/_Scripts/Scripts/Flexivel",   // Windows (UNC)
    "/Volumes/uteis/_Padroes_clientes_Alpha/_Scripts/Scripts/Flexivel",          // Mac
    "/Volumes/_Padroes_clientes_Alpha/_Scripts/Scripts/Flexivel"                 // Mac (outra montagem)
];
