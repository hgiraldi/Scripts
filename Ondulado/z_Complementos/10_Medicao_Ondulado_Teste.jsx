...
/**
 * 10_Medicao_Ondulado_Teste.jsx
 *
 * VERSAO DE TESTE (nao substitui o 10_Medicao_Ondulado.jsx).
 *
 * Diferenca para a medicao original:
 *   - A original percorre as LAYERS e usa o NOME da layer como nome da placa.
 *   - Esta percorre os GRUPOS (GroupItems) de todas as layers, descobre a COR
 *     PREDOMINANTE de cada grupo (mesma logica do 14_Risco_Faca) e nomeia cada
...
/* =============================
   ...
   - identico ao 10_Medicao_Ondulado.jsx / 14_Risco_Faca.jsx
============================= */
